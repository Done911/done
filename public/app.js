...
function logout() {
  ...
  currentUser = null;
  applyRoleUI();
  toast(authState, 'تم تسجيل الخروج بنجاح');
  if (insights) insights.textContent = 'قم بتسجيل الدخول ثم اضغط تحديث لعرض التحليلات.';
}
